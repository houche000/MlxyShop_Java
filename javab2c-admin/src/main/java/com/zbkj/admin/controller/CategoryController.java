...
public class CategoryController {
    ...
    public CommonResult<String> save(@Validated @RequestBody CategoryRequest categoryRequest) {
    ...
    @ApiImplicitParam(name = "id", value = "分类ID")
    public CommonResult<String> update(@PathVariable("id") Integer id, @RequestBody CategoryRequest categoryRequest) {
