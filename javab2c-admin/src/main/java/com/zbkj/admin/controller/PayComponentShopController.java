...
public class PayComponentShopController {
    ...
    public CommonResult<WechatVideoUploadImageResponseVo> shopImgUpload(MultipartFile file, @RequestParam(value = "media") String media) {
        return CommonResult.success(wechatVideoBeforeService.shopImgUpload(file, media));
    }
