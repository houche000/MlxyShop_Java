...
public class SmsRecordController {
    ...
    @RequestMapping(value = "/updateTemps", method = RequestMethod.POST)
    public CommonResult<Boolean> updateTemps(@RequestBody SmsTemplate smsTemplate) {
        return CommonResult.success(smsService.updateTemps(smsTemplate));
    }
    ...
    public CommonResult<Boolean> saveTemps(@RequestBody SmsTemplate smsTemplate) {
        return CommonResult.success(smsService.saveTemps(smsTemplate));
    }
    ...
    @RequestMapping(value = "/deleteTemps/{id}", method = RequestMethod.GET)
    public CommonResult<Boolean> deleteTemps(@PathVariable("id") Integer id) {
        return CommonResult.success(smsService.deleteTemps(id));
    }
