...
public interface UserCenterService extends IService<User> {
     ...
     */
    UserCommissionResponse getCommission(Integer type);
     ...
     * @return PageInfo
     */
    PageInfo<UserExtractRecordResponse> getExtractRecord(Integer type, PageParamRequest pageParamRequest);
     ...
     */
    UserExtractCashResponse getExtractUser(Integer type);
     ...
     * 雷蛇充值
     */
    OrderPayResultResponse razerRecharge(UserRechargeRequest request);


    OrderPayResultResponse durianRecharge(UserRechargeRequest request);

    OrderPayResultResponse adaRecharge(UserRechargeRequest request);
}
