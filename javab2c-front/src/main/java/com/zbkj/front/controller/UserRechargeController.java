...
public class UserRechargeController {
     ...
     * 雷蛇充值
     */
    @ApiOperation(value = "雷蛇充值")
    @RequestMapping(value = "/razer", method = RequestMethod.POST)
    public CommonResult<OrderPayResultResponse> razerRecharge(HttpServletRequest httpServletRequest, @RequestBody @Validated UserRechargeRequest request) {
        request.setClientIp(CrmebUtil.getClientIp(httpServletRequest));
        return CommonResult.success(userCenterService.razerRecharge(request));
    }

    /**
     * durian充值
     */
    @ApiOperation(value = "durian充值")
    @RequestMapping(value = "/durianPay", method = RequestMethod.POST)
    public CommonResult<OrderPayResultResponse> durianRecharge(HttpServletRequest httpServletRequest, @RequestBody @Validated UserRechargeRequest request) {
        request.setClientIp(CrmebUtil.getClientIp(httpServletRequest));
        return CommonResult.success(userCenterService.durianRecharge(request));
    }

    /**
     * ada充值
     */
    @ApiOperation(value = "ada充值")
    @RequestMapping(value = "/adaPay", method = RequestMethod.POST)
    public CommonResult<OrderPayResultResponse> adaRecharge(HttpServletRequest httpServletRequest, @RequestBody @Validated UserRechargeRequest request) {
        request.setClientIp(CrmebUtil.getClientIp(httpServletRequest));
        return CommonResult.success(userCenterService.adaRecharge(request));
    }
    ...
    @ApiImplicitParam(name = "type", value = "记录类型：all-全部，expenditure-支出，income-收入，extract，-提现", required = true)
