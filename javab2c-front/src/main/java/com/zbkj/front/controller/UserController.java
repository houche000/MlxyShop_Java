...
public class UserController {
     ...
     * 未登录修改密码
     */
    @ApiOperation(value = "未登录 - 手机号修改密码")
    @RequestMapping(value = "/notLogin/register/reset", method = RequestMethod.POST)
    public CommonResult<Boolean> registerReset(@RequestBody @Validated PasswordRequest request) {
        return CommonResult.success(userService.registerReset(request));
    }
     ...
     * 个人中心-注销账号
     */
    @ApiOperation(value = "个人中心-注销账号")
    @RequestMapping(value = "/userLogoff", method = RequestMethod.GET)
    public CommonResult<Boolean> userLogoff() {
        return CommonResult.success(userService.userLogoff());
    }
    ...
    public CommonResult<UserCommissionResponse> getCommission(Integer type) {
        return CommonResult.success(userCenterService.getCommission(type));
    }
    ...
    @RequestMapping(value = "/extract/record/{type}", method = RequestMethod.GET)
    @ApiImplicitParam(name = "type", value = "类型 提现类型1=余额,2=佣金", allowableValues = "range[1,2]", dataType = "int")
    public CommonResult<CommonPage<UserExtractRecordResponse>> getExtractRecord(@PathVariable Integer type, @Validated PageParamRequest pageParamRequest) {
        return CommonResult.success(CommonPage.restPage(userCenterService.getExtractRecord(type, pageParamRequest)));
    }
    ...
    @RequestMapping(value = "/extract/user/{type}", method = RequestMethod.GET)
    @ApiImplicitParam(name = "type", value = "类型 提现类型1=余额,2=佣金", allowableValues = "range[1,2]", dataType = "int")
    public CommonResult<UserExtractCashResponse> getExtractUser(@PathVariable Integer type) {
        return CommonResult.success(userCenterService.getExtractUser(type));
    }
