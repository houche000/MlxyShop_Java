...
public class ProductController {
     ...
     * 获取分类
     */
    @ApiOperation(value = "获取拼团分类")
    @RequestMapping(value = "/pink/category", method = RequestMethod.GET)
    public CommonResult<List<CategoryTreeVo>> getPinkCategory() {
        return CommonResult.success(productService.getPinkCategory());
    }
