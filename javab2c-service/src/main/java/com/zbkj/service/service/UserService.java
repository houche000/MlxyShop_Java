...
public interface UserService extends IService<User> {
     ...
     * @return PageInfo
     */
    PageInfo<UserResponse> listBot(UserSearchRequest request, PageParamRequest pageParamRequest);
     ...
     * @return Boolean
     */
    Boolean registerReset(PasswordRequest request);
     ...
     * @param userRequest 用户参数
     */
    Boolean updateBotUser(UserUpdateRequest userRequest);
