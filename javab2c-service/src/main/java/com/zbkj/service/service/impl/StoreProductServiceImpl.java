...
public class StoreProductServiceImpl extends ServiceImpl<StoreProductDao, StoreProduct>
    ...
    public PageInfo<StoreProductResponse> getAdminList(StoreProductSearchRequest request, PageParamRequest pageParamRequest) {
        ...
        if(request.getIsPresale() != null){
            lambdaQueryWrapper.eq(StoreProduct::getIsPresale, request.getIsPresale());
        }
    ...
    public Boolean save(StoreProductAddRequest request) {
        ...
        if (ObjectUtil.isNotNull(request.getPinkCateId())){
          storeProduct.setCateId(request.getPinkCateId() + "," + request.getCateId());
        }
        ...
        activityList.forEach(e->{
            switch (e) {
                ...
                case Constants.PRODUCT_TYPE_PINGTUAN_STR:
                    ...
                    break;
                case Constants.PRODUCT_TYPE_PRESALE_STR:
                    activities.add(Constants.PRODUCT_TYPE_PRESALE);
                    break;
            }
        });
...
//        }
        ...
        if (ObjectUtil.isNotNull(storeProductRequest.getPinkCateId())){
          storeProduct.setCateId(storeProductRequest.getPinkCateId() + "," + storeProductRequest.getCateId());
        }
...
//        }
    ...
    private List<String> getProductActivityList(String activityStr) {
        ...
        for (String s : split) {
            ...
            if (integer.equals(Constants.PRODUCT_TYPE_PRESALE)) {
                activityList.add(Constants.PRODUCT_TYPE_PRESALE_STR);
            }
        }
        return activityList;
    }
    ...
    public List<StoreProduct> getIndexProduct(Integer type, PageParamRequest pageParamRequest) {
        ...
        lambdaQueryWrapper.select(StoreProduct::getId, StoreProduct::getImage, StoreProduct::getStoreName, StoreProduct::getStoreNameEn,
                StoreProduct::getStoreNameMy, StoreProduct::getPrice, StoreProduct::getOtPrice, StoreProduct::getActivity);
        switch (type) {
    ...
    public List<StoreProduct> findH5List(ProductRequest request, PageParamRequest pageRequest) {
        ...
        // id、名称、图片、价格、销量、活动
        lqw.select(StoreProduct::getId, StoreProduct::getStoreName, StoreProduct::getStoreNameEn,
                StoreProduct::getStoreNameMy, StoreProduct::getImage, StoreProduct::getPrice,
        ...
        lqw.eq(StoreProduct::getIsPresale, false);
    ...
    public StoreProduct getH5Detail(Integer id) {
        LambdaQueryWrapper<StoreProduct> lqw = Wrappers.lambdaQuery();
        lqw.select(StoreProduct::getId, StoreProduct::getImage, StoreProduct::getStoreName, StoreProduct::getStoreNameEn,
                StoreProduct::getStoreNameMy, StoreProduct::getSliderImage,
    ...
    public List<StoreProduct> getLeaderboard() {
        ...
        queryWrapper.select("id", "store_name", "store_name_en", "store_name_my", "image", "price", "ot_price", "(sales + ficti) as sales");
