...
public class UserBillServiceImpl extends ServiceImpl<UserBillDao, UserBill> implements UserBillService {
    ...
    */
     ...
     */
    @Override
    public BigDecimal getSumBigDecimal(Integer pm, Integer userId, String category, String date, String type, String excludeType) {
        QueryWrapper<UserBill> queryWrapper = new QueryWrapper<>();
        ...
        if (null != type) {
            queryWrapper.ne("type", excludeType);
        }
        if (null != date) {
    ...
    public PageInfo<UserBill> nowMoneyBillRecord(Integer uid, String type, PageParamRequest pageRequest) {
        ...
        switch (type) {
            ...
            case "expenditure":
                ...
                lqw.ne(UserBill::getType, "extract");
                break;
            case "income":
            ...
            case "extract":
                lqw.eq(UserBill::getPm, 1);
                lqw.eq(UserBill::getType, "extract");
        }
