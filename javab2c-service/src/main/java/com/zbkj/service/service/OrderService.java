...
public interface OrderService {
     ...
     * 订单物流查看
     */
    Object expressOrder(String orderId, String type);
     ...
     * @return
     */
    CommonPage<StorePinkResponse> combinationOrderList(Integer type, Boolean isWinner, PageParamRequest pageRequest);
     ...
     * @return
     */
    List<Map<String, Object>> combinationOrderCount();
}
