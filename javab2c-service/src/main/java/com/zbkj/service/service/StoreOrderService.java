...
public interface StoreOrderService extends IService<StoreOrder> {
     ...
     *
     * @param uid              用户uid
     * @param status           拼团状态，1=拼团中,2=拼团成功,3=拼团失败
     * @param isWinner         是否中奖
     * @param pageParamRequest 分页参数
     * @return 订单结果列表
     */
    List<StorePink> getUserCombinationOrderList(Integer uid, Integer status, Boolean isWinner, PageParamRequest pageParamRequest);
     ...
     * @return
     */
    boolean refundYue(String orderNo);
     ...
     */
    LogisticsResultVo getLogisticsInfo(String orderNo, String type);
     ...
     * @return  用户当前的砍价订单
     */
    List<StoreOrder> getUserCurrentPresaleOrders(Integer uid, Integer presaleId);
