...
public interface StorePinkService extends IService<StorePink> {
     ...
     * @return
     */
    PageInfo<StorePinkDetailResponse> getAdminList(StorePinkSearchRequest request, PageParamRequest pageParamRequest);
     ...
     * @param kid
     */
    List<StorePink> getListByCidAndKid(Integer cid, Integer kid, Integer limit);
