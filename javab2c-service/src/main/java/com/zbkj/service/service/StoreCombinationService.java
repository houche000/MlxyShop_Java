...
public interface StoreCombinationService extends IService<StoreCombination> {
     ...
     * 新增拼团商品
     */
    Integer saveCombination(StoreCombinationRequest request);
     ...
     * H5拼团商品列表
     */
    List<StoreCombinationH5Response> getH5List(ProductRequest request, PageParamRequest pageParamRequest);
     ...
     * @return
     */
    CommonPage<StorePinkResponse> combineList(StorePinkSearchRequest request, PageParamRequest pageParamRequest);
