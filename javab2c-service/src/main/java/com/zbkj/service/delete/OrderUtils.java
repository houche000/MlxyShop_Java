    ...
    public Boolean checkPayType(String payType){
        ...
        switch (payType){
            ...
            case PayConstants.PAY_TYPE_ALI_PAY:
                ...
                break;
            case PayConstants.PAY_TYPE_YY_PAY:
                result = (systemConfigService.getValueByKey(SysConfigConstants.CONFIG_YY_PAY_STATUS).equals("1"));
                break;
            case PayConstants.PAY_TYPE_RAZER_PAY:
                result = (systemConfigService.getValueByKey(SysConfigConstants.CONFIG_RAZER_PAY_STATUS).equals("1"));
                break;
            case PayConstants.PAY_TYPE_DURIAN_PAY:
                result = (systemConfigService.getValueByKey(SysConfigConstants.CONFIG_DURIAN_PAY_STATUS).equals("1"));
                break;
            case PayConstants.PAY_TYPE_ADA_PAY:
                result = (systemConfigService.getValueByKey(SysConfigConstants.CONFIG_ADA_PAY_STATUS).equals("1"));
                break;
            case PayConstants.PAY_TYPE_KAB_PAY:
                result = (systemConfigService.getValueByKey(SysConfigConstants.CONFIG_KAB_PAY_STATUS).equals("1"));
                break;
        }
        return result;
    }
