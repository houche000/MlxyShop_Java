...
@ApiModel(value = "IntegralUserResponse对象", description = "用户金豆响应对象")
...
//    private Boolean isYesterdaySign;
    ...
    @ApiModelProperty(value = "累计总金豆")
    private Integer sumIntegral;

    @ApiModelProperty(value = "累计抵扣金豆")
    private Integer deductionIntegral;

//    @ApiModelProperty(value = "今日获得累计金豆")
//    private Integer nowIntegral;

    @ApiModelProperty(value = "冻结的金豆")
