...
public class IntegralRecordConstants {
     ...
     * 佣金记录标题—签到经验奖励
     */
    public static final String BROKERAGE_RECORD_TITLE_SIGN = "签到金豆奖励";

    /**
     * 佣金记录标题—后台金豆操作
     */
    public static final String BROKERAGE_RECORD_TITLE_SYSTEM = "后台金豆操作";

    /**
     * 佣金记录标题—拼团开团奖励
     */
    public static final String BROKERAGE_RECORD_TITLE_COMBINATION = "拼团开团奖励";
     ...
     * 佣金记录标题—金豆抽奖
     */
    public static final String BROKERAGE_RECORD_TITLE_LUCK_LOTTERY = "金豆抽奖";
