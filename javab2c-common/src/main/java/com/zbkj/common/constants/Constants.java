...
public class Constants {
    ...
    // 用户类型 bot
    public static final String USER_LOGIN_TYPE_BOT = "bot";
...
//    public static final String SKU_STOCK_LIST = "product_stock_list";
    ...
    public static final String CONFIG_EXTRACT_SERVICE_HARGE = "user_extract_service_harge"; //手续费
    public static final String CONFIG_USER_WITHDRAW_TIME = "store_user_withdraw_time"; //提现时间
    ...
    public static final String CONFIG_KEY_PAY_KAB_U = "pay_kab_u"; //渠道代码
    public static final String CONFIG_KEY_PAY_KAB_KEY = "pay_kab_key"; //api密钥
    public static final String CONFIG_KEY_PAY_KAB_PAY_URL = "pay_kab_pay_url"; //支付地址
    public static final String CONFIG_KEY_PAY_KAB_PM = "pay_kab_pm"; //支付渠道
    public static final String CONFIG_KEY_PAY_KAB_CALLBACK_URL = "pay_kab_callback_url"; //通知地址
...
//    public static final String CONFIG_KEY_PUBLIC_LOGO = "wechat_avatar"; //公众号logo
    ...
    public static final String CONFIG_KEY_STORE_INTEGRAL_EXTRACT_TIME = "freeze_integral_day"; //金豆冻结时间
    ...
    //金豆
    public static final String CONFIG_KEY_INTEGRAL_RATE = "integral_ratio"; //金豆抵用比例(1金豆抵多少金额
    public static final String CONFIG_KEY_INTEGRAL_RATE_ORDER_GIVE = "order_give_integral"; //下单支付金额按比例赠送金豆（实际支付1元赠送多少金豆
    ...
    public static final Integer PRODUCT_TYPE_PRESALE= 5;
    public static final String PRODUCT_TYPE_PRESALE_STR = "预售";
    ...
    //签到
    public static final Integer SIGN_TYPE_INTEGRAL = 1; //金豆
    public static final Integer SIGN_TYPE_EXPERIENCE = 2; //经验
    public static final String SIGN_TYPE_INTEGRAL_TITLE = "签到金豆奖励"; //金豆
    ...
    public static final String USER_BILL_CATEGORY_INTEGRAL = "integral"; //金豆
    ...
    public static final String USER_BILL_TYPE_PAY_PRODUCT_INTEGRAL_BACK = "pay_product_integral_back"; //商品退金豆
    ...
    public static final String PAY_TYPE_ADA_PAY = "adapay";

    //退款类型
    /**
     * 原路退款
     */
    public static final Integer REFUND_TO_GO = 0;
    /**
     * 退款到余额
     */
    public static final Integer REFUND_TO_YUE = 1;
    ...
    //物流  https://market.aliyun.com/products/57126001/cmapi019423.html
    public static String LOGISTICS_API_URL = "https://kuaidi100.market.alicloudapi.com/getExpress";
