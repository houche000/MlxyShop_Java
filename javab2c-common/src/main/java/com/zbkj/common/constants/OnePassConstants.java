...
//    public static final String ONE_PASS_API_URL = "http://plat.crmeb.net/api/";// 测试环境
    ...
    // 牛信云短信请求地址
    public static final String SMS_NXCLOUD_API_URL = "http://api2.nxcloud.com/api/sms/mtsend";

    // 聚合短信请求地址
    public static final String SMS_JUHE_API_URL = "http://v.juhe.cn/sms/send";
