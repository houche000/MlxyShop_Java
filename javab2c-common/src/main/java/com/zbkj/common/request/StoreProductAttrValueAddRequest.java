...
//    private Integer sales;
    ...
    @ApiModelProperty(value = "规格属性开团金额", required = true)
    @NotNull(message = "规格属性开团金额不能为空")
    @DecimalMin(value = "0", message = "金额不能小于0")
    private BigDecimal ktPrice;

    @ApiModelProperty(value = "规格属性参团金额", required = true)
    @NotNull(message = "规格属性参团金额不能为空")
    @DecimalMin(value = "0", message = "金额不能小于0")
    private BigDecimal ctPrice;

    @ApiModelProperty(value = "开团奖励金豆", required = true)
    @NotNull(message = "规格开团奖励金豆不能为空")
    @DecimalMin(value = "0", message = "开团奖励金豆不能小于0")
    private Integer ktIntegral;

    @ApiModelProperty(value = "鼓励佣金", required = true)
    @NotNull(message = "鼓励佣金不能为空")
    @DecimalMin(value = "0", message = "鼓励佣金不能小于0")
